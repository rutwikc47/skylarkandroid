...
import com.rccorp.skylark.Skylark;
...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(Skylark.getInstance(), "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    private static void showToast(String msg) {
        Toast.makeText(Skylark.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }
